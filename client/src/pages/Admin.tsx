...
const Admin: React.FC = () => {
    ...
    const blogForm = useSelector((state: RootState) => state.blogs.blogForm)
    const navigate = useNavigate()
    const dispatch = useDispatch();

    useEffect(() => {
        axios.get(userProfile, { withCredentials: false })
            .then((res) => {
        ...
        <>
            ...
            <div className="w-[1120px] m-auto px-4 min-h-[80vh] pb-8 bg-gray-50">
                ...
                <div className='ml-[215px] w-[870px] my-10 bg-white rounded-3xl  shadow-md'>
                    <div className=' pb-10 pt-4 px-3 bg-[radial-gradient(circle_at_top_right,_#ffeacee4,_transparent)] rounded-3xl'>
